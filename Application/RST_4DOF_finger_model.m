classdef RST_4DOF_finger_model < handle
    ...
    methods
        ...
        function createFingerModel(obj)
            ...
            jnt2.PositionLimits = [deg2rad(-55), deg2rad(90)]; % Limit MCP flexion/extension
            setFixedTransform(jnt2, dhparams(2, :), 'dh');
            body2.Joint = jnt2;
            
            body3 = rigidBody('body3');
            jnt3 = rigidBodyJoint('PIP', 'revolute');
            jnt3.PositionLimits = [-deg2rad(27.5), deg2rad(135)]; % Limit PIP flexion/extension
            setFixedTransform(jnt3, dhparams(3, :), 'dh');
            body3.Joint = jnt3;
            
            body4 = rigidBody('body4');
            jnt4 = rigidBodyJoint('DIP', 'revolute');
            jnt4.PositionLimits = [-deg2rad(31), deg2rad(97.5)]; % Limit DIP flexion/extension
